...
public class Testit {
    public static void main(String[] args) {
        ...
        String [] nameListe = {"Fluffy","Snape","Karl","Reinhard","Minnie","Gini","Jacky"};
        String [] farbeListe = {"braune","schwarze","regenbogenfarbene","obsidianfarbene","karrierte"};
        String [] oberListe = {"glatt","glitzernde","rau","samtig","weich","flauschig"};
